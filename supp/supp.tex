...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=\textwidth]{figs/snps-per-clump}
  \caption{SNPs per clump in the 240 simulations, before and after
    ...
    SNPs per clump was 19.9 and 8.8 (before and after, respectively),
    and the median number of SNPs per clump was 15 and 8.}
\end{figure}
